...
/**
 * Servlet implementation class UpdateLocationTransactionServlet
 */
@WebServlet("/UpdateLocationTransactionServlet")
public class UpdateLocationTransactionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateLocationTransactionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		iLocationTransactionService.updateLocationTransactionReq(ID, lt);
