...
/**
 * Servlet implementation class SupplierDeleteAccountById
 */
@WebServlet("/SupplierDeleteAccountById")
public class SupplierDeleteAccountById extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupplierDeleteAccountById() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		supplier.deleteSupplierAccounttById(supID);
