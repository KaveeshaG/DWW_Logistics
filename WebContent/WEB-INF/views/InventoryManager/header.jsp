...
<%@page import="com.wms.model.InventoryNotifications"%>
...
<%
	...
	ArrayList<InventoryNotifications> list = manager.getAllNotifications("IM");
	int count  =  manager.getImNotificationCount("IM");
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">DWW</div>
      </a>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link btn" href="test?action=IMH" >
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class=" collapse-item" href="test?action=IRP" >Replacing Inventory</a>
            <a class="collapse-item" href="test?action=IRF" >Refilling Inventory</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="Purchase" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Inventory Products:</h6>
            <a class=" collapse-item" href="test?action=IPO" >All Purchase Orders</a>
            <a class="collapse-item" href="#addPurchaseOrder" data-toggle="modal" data-target="#addPurchaseOrder">Add New</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="test?action=SUP">
          <i class="fas fa-users"></i>
          <span>Supplier Management</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="test?action=SALES">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in overflow-auto" aria-labelledby="alertsDropdown">
                ...
                <%
                	for(InventoryNotifications notifications : list){
                %>
                
                <form action="IMNotificationManager" method="POST">
                <input type="hidden" name="poID" value="<%=notifications.getDataID()%>">
                <input type="hidden" name="ID" value="<%=notifications.getId()%>">
                <input type="hidden" name="type" value="<%=notifications.getType()%>">
                <button class="dropdown-item d-flex align-items-center" href="">
                  ...
                  <div>
                    ...
                    <span class="">
                    <%if(notifications.getSeenState().equals("Unseen")) {%>
                    <b><%} %>
                    
                    <%=notifications.getDescription()%>
                     <%if(notifications.getSeenState().equals("Unseen")) {%>
                     </b>
                     <%} %>
                     
                     </span>
                    <div class="small text-gray-500"><%=notifications.getDate()%></div>
                  </div>
                </button>
                <%
                	}
