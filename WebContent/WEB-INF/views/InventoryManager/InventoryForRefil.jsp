...
<title>Refilling Inventory</title>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="card">
                            ...
                            <div class="content">
 								<div class="container-fluid">                         
                                <form method="POST" action="AddRefillingItem" name="Refill"
							onsubmit="return InventoryRefill()">
                                    <div class="row">
                                        <div class="col-md-6">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="card">
                            ...
                            <div class="content">
 								<div class="container-fluid">                         
                                <form method="POST" action="UpdateItemsServelet?action=RF" name="RefillUPPDATE" onsubmit="return InventoryRefilluPDATE()">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
