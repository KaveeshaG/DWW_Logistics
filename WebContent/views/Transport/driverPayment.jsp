        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Drivers Payment</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <div class="download-btn">
                  <a onclick="exportTableToCSV('DriverPaymentDetails.csv')" class="btn btn-success btn-circle btn-lg">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="updatepage.jsp" class="btn btn-warning btn-icon-split">
                          <span class="icon text-white-50">
                            <i class="far fa-edit"></i>
                          </span>
                        </a>
                        <a onclick="deleting()" class="btn btn-danger btn-icon-split">
                          <span class="icon text-white-50">
