  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
        <!-- Body 1-->
        <div class="container-fluid" style="color: black; font-family: Poppins,sans-serif;">
          <!-- Content Row -->
          <div class="row">
            <div class="col-xl-4 col-lg-7 ">
              <!-- Area Chart -->
              <div class="card shadow mb-4 border-top">
                <div class="card-body-pro">
                  <div class="row">
                    <div class="profile-userpic">
                      <img src="img/usrbig1.jpg" class="img-responsive" alt=""> </div>
                  </div>
                  <div class="profile-usertitle">
                    <div class="profile-usertitle-name"> John Deo </div>
                    <div class="profile-usertitle-job"> Driver ID </div>
                  </div>
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Complete</b> <a class="pull-right">1,200</a>
                    </li>
                    <li class="list-group-item">
                      <b>Cancel</b> <a class="pull-right">750</a>
                    </li>
                    <li class="list-group-item">
                      <b>Rate</b> <a class="pull-right">4.5</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-xl-8 col-lg-5">
              <div class="card shadow mb-4 border-top">
                <!-- Card Body -->
                <div class="card-body-pro">
                  <div class="card-head-pro card-topline-aqua">
                    <header>About Me</header>
                  </div>
                  <div class="no-padding">
                    <div class="profile-desc-pro">
