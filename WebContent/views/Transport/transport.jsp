              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <canvas id="myAreaChart" style="display: block; width: 387px; height: 320px;" width="774"
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4">
                    ...
                    <canvas id="myPieChart" width="514" height="506" class="chartjs-render-monitor"
                      style="display: block; width: 257px; height: 253px;"></canvas>
                  </div>
                  <hr>
