      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="LocationTransaction.jsp">Location Change</a>
            <a class="collapse-item" href="LocationTransactionRequest.jsp">Location Transfer Request</a>
            <!-- <a class="collapse-item" href="utilities-animation.html">Generate Stock Report</a> -->
          </div>
        </div>
      </li>
