                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                              ...
                              <input type="number" class="form-control form-control-sm" id="NoOfProducts" placeholder="No Of Products" name="NoOfProducts" min="1" required>
                            </div>
                        </div>
                    </div>
...
/*   $('#ETime').on("change", function() {
	  ...
	  var timeStart = new Date("01/01/2019 " + valuestart).getHours();
	  var timeEnd = new Date("01/01/2019 " + valuestop).getHours();
