    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseItem" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="reqitem.jsp">Add New Item</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Warehouse Location</h6>
            <a class="collapse-item" href="Location.jsp">Show Locations</a>
            <!-- <a class="collapse-item" href="utilities-border.html">Location Change</a> -->
            <a class="collapse-item" href="LocationTransactionAdmin.jsp">Show Change Request</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#dis" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-minus-circle"></i>
          <span>Good Dispatch</span>
        </a>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#emp" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-minus-circle"></i>
          <span>Employee</span>
        </a>
